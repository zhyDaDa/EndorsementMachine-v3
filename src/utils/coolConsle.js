export const echo = (function() {
    ...
    function successFormatting(value) {
        ...
        queue.push({
            value: value,
            css: "display: inline-block ; background-color: #00a000 ; color: #ffffff ; font-weight: bold ; padding: 3px 7px 3px 7px ; border-radius: 3px 3px 3px 3px ;"
        });
    ...
    // Attach formatting utility method.
    function specialFormatting(value) {

        queue.push({
            value: value,
            css: "display: inline-block ; background-color: #2a6aaa ; color: #ffffff ; font-weight: bold ; padding: 3px 7px 3px 7px ; border-radius: 3px 3px 3px 3px ;"
        });
